...
namespace WebHoaLan.Areas.Customer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index(int? page)
        {
            ...
            //var products = _db.Products.Where(p => p.ProductTypes == ProductTypes).ToList();
        }
        ...
        public ActionResult Detail(int? id)
        {
            ...
            var product = _db.Products.Include(c => c.ProductTypes).FirstOrDefault(c => c.ProductsId == id);
            if (product == null)
            {
                return NotFound();
            }
        ...
        public IActionResult RemoveToCart(int? id)
        {
            ...
            if (products != null)
            {
                var product = products.FirstOrDefault(c => c.ProductsId == id);
                if (product != null)
                {
